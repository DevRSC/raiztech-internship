...
export default function Dropdown({ getFilteredRegion, regions }: Props) {
  ...
  return (
    <Menu as='div' className='relative inline-block text-left'>
      <div>
        <Menu.Button className='inline-flex px-5 py-2 text-xs font-medium text-gray-600 transition-colors duration-200 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-800 sm:text-sm'>
          Regions
          <ChevronDownIcon
