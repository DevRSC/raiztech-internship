...
export default function Dropdown({ getFilteredRegion, regions }: Props) {
  ...
  return (
    <Menu as='div' className='relative inline-block text-left'>
      <div>
        <Menu.Button className='inline-flex w-full justify-center gap-x-1.5 rounded-md px-5  text-gray-600 transition-colors duration-200 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-800 sm:text-sm'>
          Regions
          <ChevronDownIcon
